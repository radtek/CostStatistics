...
public:
	...
	virtual void  SetText(LPCTSTR szText)        { m_strText = szText;m_vStrText.clear();m_vStrText.push_back(szText);}                
	virtual void  PullText(LPTSTR str)			 { m_vStrText.push_back(str);};                
	...
	virtual vector<CString>  GetTextVec() const		{return m_vStrText;}
	virtual vector<CString>& GetTextVec()   		{return m_vStrText;}
