...
public:
	...
	void SetData(const CStringArray& ar);

    void  SetStyle(DWORD dwStyle)           { m_dwStyle = dwStyle; }
    DWORD GetStyle()                        { return m_dwStyle;    }
	void InsertString(int nPos,CString str);
	void GetOptions(CStringArray& arr){arr.Copy(m_Strings);}
	void GetData(CStringArray& arrData){arrData.Copy(m_arrData);}
protected:
...
public:
    ...
    void EndEdit();
	int  FindInputString( CString & str);
