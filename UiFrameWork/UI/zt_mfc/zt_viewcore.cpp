...
AFX_DATADEF zt_AUX_DATA zt_afxData;

#define ZT_CVIEW_CLASSNAME _T("zt_CView_ClassName")


/////////////////////////////////////////////////////////////////////////////
// CView

BEGIN_MESSAGE_MAP(zt_CView, CWnd)
	//{{AFX_MSG_MAP(CView)
	ON_WM_PAINT()
	ON_WM_MOUSEACTIVATE()
	ON_WM_CREATE()
	...
	ON_COMMAND_EX(ID_WINDOW_SPLIT, &zt_CView::OnSplitCmd)
	ON_UPDATE_COMMAND_UI(ID_WINDOW_SPLIT, &zt_CView::OnUpdateSplitCmd)

	// Standard commands for next pane
	ON_UPDATE_COMMAND_UI(ID_NEXT_PANE, &zt_CView::OnUpdateNextPaneMenu)
	ON_COMMAND_EX(ID_NEXT_PANE, &zt_CView::OnNextPaneCmd)
	ON_UPDATE_COMMAND_UI(ID_PREV_PANE, &zt_CView::OnUpdateNextPaneMenu)
	ON_COMMAND_EX(ID_PREV_PANE, &zt_CView::OnNextPaneCmd)
	//}}AFX_MSG_MAP
	// special command for Initial Update
	ON_MESSAGE_VOID(WM_INITIALUPDATE, zt_CView::OnInitialUpdate)
END_MESSAGE_MAP()
...
zt_CView::zt_CView()
{
	...
	if(!(::GetClassInfo(hInst, ZT_CVIEW_CLASSNAME, &wndclass)))
	{
		...
		wndclass.lpszClassName = ZT_CVIEW_CLASSNAME;
...
BOOL zt_CView::PreCreateWindow(CREATESTRUCT & cs)
{
	...
	if (cs.lpszClass == NULL)
	{
		...
		//cs.lpszClass = _T("AfxFrameOrView90ud");
		cs.lpszClass = ZT_CVIEW_CLASSNAME;
	}
...
int zt_CView::OnCreate(LPCREATESTRUCT lpcs)
{
...
void zt_CView::CalcWindowRect(LPRECT lpClientRect, UINT nAdjustType)
{
	...
	if (nAdjustType != 0)
	{
		...
		{
			int nAdjust = zt_afxData.cxVScroll;
		...
		{
			int nAdjust = zt_afxData.cyHScroll;
			if (dwStyle & WS_BORDER)
...
BOOL zt_CView::OnCmdMsg(UINT nID, int nCode, void* pExtra,
...
void zt_CView::OnInitialUpdate()
{
	OnUpdate(NULL, 0, NULL);        // initial update
}

void zt_CView::OnUpdate(zt_CView* pSender, LPARAM /*lHint*/, CObject* /*pHint*/)
{
	ASSERT(pSender != this);
...
void zt_CView::OnPrint(CDC* pDC, CPrintInfo*)
{
	ASSERT_VALID(pDC);
...
BOOL zt_CView::IsSelected(const CObject* pDocItem) const
{
...
void zt_CView::OnActivateView(BOOL bActivate, zt_CView* pActivateView, zt_CView*)
{
...
void zt_CView::OnActivateFrame(UINT /*nState*/, CFrameWnd* /*pFrameWnd*/)
{
}

int zt_CView::OnMouseActivate(CWnd* pDesktopWnd, UINT nHitTest, UINT message)
{
	...
	//	zt_CView* pView = (zt_CView*)pParentFrame->GetActiveView();
...
BOOL zt_CView::OnScroll(UINT /*nScrollCode*/, UINT /*nPos*/, BOOL /*bDoScroll*/)
{
	return FALSE;
}

BOOL zt_CView::OnScrollBy(CSize /*sizeScroll*/, BOOL /*bDoScroll*/)
{
	return FALSE;
}
...
DROPEFFECT zt_CView::OnDragScroll(DWORD /*dwKeyState*/, CPoint /*point*/)
{
...
DROPEFFECT zt_CView::OnDragEnter(COleDataObject* /*pDataObject*/,
	DWORD /*dwKeyState*/, CPoint /*point*/)
{
	return 0;   // DROPEFFECT_NONE
}

DROPEFFECT zt_CView::OnDragOver(COleDataObject* /*pDataObject*/,
	DWORD /*dwKeyState*/, CPoint /*point*/)
{
	return 0;   // DROPEFFECT_NONE
}

BOOL zt_CView::OnDrop(COleDataObject* /*pDataObject*/,
	DROPEFFECT /*dropEffect*/, CPoint /*point*/)
{
	return FALSE;
}

DROPEFFECT zt_CView::OnDropEx(COleDataObject* /*pDataObject*/,
	DROPEFFECT /*dropEffect*/, DROPEFFECT /*dropEffectList*/, CPoint /*point*/)
{
	return (DROPEFFECT)-1;  // not implemented
}

void zt_CView::OnDragLeave()
{
}
...
CSplitterWnd* PASCAL
zt_CView::GetParentSplitter(const CWnd* pWnd, BOOL bAnyState)
{
	ENSURE_VALID(pWnd);
...
CScrollBar* zt_CView::GetScrollBarCtrl(int nBar) const
{
...
void zt_CView::OnUpdateSplitCmd(CCmdUI* pCmdUI)
{
...
void zt_CView::OnUpdateNextPaneMenu(CCmdUI* pCmdUI)
{
...
BOOL zt_CView::OnNextPaneCmd(UINT nID)
{
	CSplitterWnd* pSplitter = GetParentSplitter(this, FALSE);
	if (pSplitter == NULL)
		return FALSE;
...
void zt_CView::OnPrepareDC(CDC* pDC, CPrintInfo* pInfo)
{
	ASSERT_VALID(pDC);
...
BOOL zt_CView::OnPreparePrinting(CPrintInfo*)
{
...
void zt_CView::OnBeginPrinting(CDC* pDC, CPrintInfo*)
{
	ASSERT_VALID(pDC);
	UNUSED(pDC);     // unused in release builds
...
void zt_CView::OnEndPrinting(CDC* pDC, CPrintInfo*)
{
	ASSERT_VALID(pDC);
	UNUSED(pDC);     // unused in release builds
...
void zt_CView::OnEndPrintPreview(CDC* pDC, CPrintInfo* pInfo,
...
#ifdef _DEBUG
void zt_CView::Dump(CDumpContext& dc) const
{
	CWnd::Dump(dc);
...
void zt_CView::AssertValid() const
{
	CWnd::AssertValid();
}
#endif //_DEBUG

IMPLEMENT_DYNAMIC(zt_CView, CWnd)

/////////////////////////////////////////////////////////////////////////////
// CCtrlView
//
//BEGIN_MESSAGE_MAP(CCtrlView, zt_CView)
//	ON_WM_PAINT()
//END_MESSAGE_MAP()
//
//CCtrlView::~CCtrlView()
...
//
//	return zt_CView::PreCreateWindow(cs);
//}
//
...
//IMPLEMENT_DYNAMIC(CCtrlView, zt_CView)
//
///////////////////////////////////////////////////////////////////////////////
